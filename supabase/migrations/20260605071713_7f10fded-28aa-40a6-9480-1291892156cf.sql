...
DECLARE
    ...
    v_os_mao_obra_global NUMERIC := 0;
...
BEGIN
    ...
    SELECT 
        ...
        COALESCE(SUM(os.valor_mao_obra), 0)
    INTO v_os_total, v_total_descontos, v_os_custo, v_os_mao_obra_global
    ...
    -- 2. FATURAMENTO VENDAS BALCÃO E CUSTO
    ...
    -- Somar mão de obra global das OS ao faturamento de serviços
    v_valor_servicos := v_valor_servicos + v_os_mao_obra_global;
    
    -- Somar Vendas Balcão às métricas de peças
