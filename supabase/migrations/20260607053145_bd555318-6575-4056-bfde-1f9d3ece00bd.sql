-- 1. RESTAURAR RPC COM VALIDAÇÃO UNIVERSAL ROBUSTA
...
BEGIN
  -- Validação Universal: Dono, Equipe Ativa ou Service Role
  SELECT EXISTS(
  ...
  -- Se não tem acesso, retorna zeros seguros com flag de erro
  ...
  -- Cálculos Reais (Fonte: Financeiro)
  SELECT
