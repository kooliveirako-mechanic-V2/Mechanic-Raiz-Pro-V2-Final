...
BEGIN
    ...
    recebido_vinculado AS (
        -- Como venda_balcao_id não existe em financeiro, vinculamos apenas OS por enquanto.
        -- Vendas balcão costumam ser pagas no ato, então o caixa de entradas já as reflete.
