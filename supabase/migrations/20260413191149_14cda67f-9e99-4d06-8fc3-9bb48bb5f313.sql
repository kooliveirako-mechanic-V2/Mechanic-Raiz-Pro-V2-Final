-- =====================================================
-- FIX: Remover valor_total do INSERT INTO itens_os
-- A coluna é GENERATED ALWAYS — não aceita inserção manual
-- =====================================================

-- RPC 1: CRIAR OS COMPLETA (CORRIGIDA)
...
BEGIN
  ...
  LOOP
    ...
    BEGIN
      ...
      -- FIX: Removed valor_total from INSERT — column is GENERATED ALWAYS
...
-- =====================================================
-- RPC 2: FINALIZAR OS ATÔMICA (CORRIGIDA)
-- =====================================================
...
BEGIN
  ...
  -- Insert new items WITHOUT valor_total (GENERATED ALWAYS)
  ...
  LOOP
    ...
    BEGIN
      ...
      -- FIX: Removed valor_total from INSERT
      INSERT INTO public.itens_os (
        ordem_servico_id, nome_item, quantidade,
        valor_unitario, valor_mao_obra,
        estoque_id
  ...
  -- Calculate totals from all items (using generated column)
  SELECT 
