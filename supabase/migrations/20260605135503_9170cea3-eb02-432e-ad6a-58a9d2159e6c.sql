-- 1. Atualizar RPC com métricas de auditoria avançada
...
BEGIN
    ...
    -- 4. FINANCEIRO (CAIXA) E SALDO A RECEBER
    SELECT 
    ...
    -- Divergências e Pagamentos Parciais
    SELECT 
    ...
    IF v_faturamento_bruto > 0 THEN
        ...
        v_valor_pecas_liquido := v_valor_pecas_liquido + v_diferenca_centavos; -- Simplificado para peças
    END IF;
