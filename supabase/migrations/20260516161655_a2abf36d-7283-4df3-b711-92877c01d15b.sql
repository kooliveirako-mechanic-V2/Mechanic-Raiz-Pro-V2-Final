...
BEGIN
  ...
  SELECT COALESCE(os.valor_servico, 0), COALESCE(os.desconto, 0)
  INTO v_valor_servico, v_desconto
  ...
  SELECT json_build_object(
    ...
    'desconto', COALESCE(os.desconto, 0),
    'desconto_motivo', os.desconto_motivo,
    ...
    'saldo_restante', GREATEST(v_valor_servico - v_desconto - v_total_sinais, 0),
