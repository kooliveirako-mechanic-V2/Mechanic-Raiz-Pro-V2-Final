...
BEGIN
  -- Se for o dono ko.oliveira2016, acesso liberado
  ...
  RETURN jsonb_build_object(
    ...
    'caixa', jsonb_build_object('entradas_oficina_periodo', v_faturamento, 'saidas_oficina_periodo', v_despesas),
    'acesso_negado', false
  );
END;
$$;